...
exports.getBalance = async (req, res, next) => {
  try {
    ...
    const { usedDays, pendingDays } = await getLeaveBalance(id, year);
    ...
    res.json({
      data: {
        ...
        usedDays,
        pendingDays,
        remainingDays: employee.totalLeaveDays - usedDays,
        availableDays: employee.totalLeaveDays - usedDays - pendingDays,
      },
    });
  } catch (error) {
    next(error);
